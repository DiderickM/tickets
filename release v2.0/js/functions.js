...
function displayList(data) {
    //hou rekening met het leerling nummer
    var leerlingnum = parseInt(readCookie('Leerlingnum') - 1);
    var lengteVanArray = data.length;
    ...
    if(lengteVanArray % 2){
        ...
        for (var i = leerlingnum; i < lengteVanArray; i = i + 2) { 
            var nummer = data[i]
            var naam = data[i + 1];
